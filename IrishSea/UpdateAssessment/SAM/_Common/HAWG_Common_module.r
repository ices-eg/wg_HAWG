...
source(file.path(my.path,".\\_Common\\writeStandardOutput.r"))
source(file.path(my.path,".\\_Common\\WriteIcaSum.r"))
...
timeseries <- function(stck.,slot.,...){
                ...
                par.settings=list(superpose.symbol=list(pch=as.character(1:8),cex=1.25))))}
