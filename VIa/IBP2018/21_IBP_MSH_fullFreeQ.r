...
MSH.ctrl@catchabilities[-1,ac(9)]            <- 401:404
...
mean(mohns.rho(MSH.retro,ref.year=2017,span=7,type="ssb")[3:7,1])
mean(mohns.rho(MSH.retro,ref.year=2017,span=7,type="rec")[3:7,1])
mean(mohns.rho(MSH.retro,ref.year=2017,span=7,type="fbar")[3:7,1])