...
MSH.ctrl@obs.vars["catch N",1:9]            <- c(101,102,rep(103,5),rep(104,2))    x
...
MSH.ctrl@cor.obs.Flag[3]                    <- as.factor("AR")

#MSH.ctrl@cor.obs["IBTS_Q1",2:8]             <- c(201,rep(202,6))
#MSH.ctrl@cor.obs.Flag[2:4]                  <- as.factor("AR")
...
run_name            <- "corMSHERAS_000rest1_mf"
