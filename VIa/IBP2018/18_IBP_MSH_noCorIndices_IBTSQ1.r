...
MSH.ctrl@cor.obs["WoS HERAS",]              <- c(102,rep(102,7))
#MSH.ctrl@cor.obs["IBTS_Q1",2:8]             <- c(rep(202,7))
MSH.ctrl@cor.obs["IBTS_Q4",2:8]             <- c(303,rep(303,6))

#- Set cor flags
MSH.ctrl@cor.obs.Flag[c(2:3,5)]                  <- as.factor("AR")
