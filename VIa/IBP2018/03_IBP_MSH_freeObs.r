...
MSH.ctrl@obs.vars["catch unique",]          <- c(1:8,8)
MSH.ctrl@obs.vars["MS HERAS",1:9]           <- c(101:108,108)
MSH.ctrl@obs.vars["WoS HERAS",1:9]          <- c(201:208,208)
MSH.ctrl@obs.vars["IBTS_Q1",2:9]            <- c(302:308,308)
MSH.ctrl@obs.vars["IBTS_Q4",2:9]            <- c(402:408,408)
