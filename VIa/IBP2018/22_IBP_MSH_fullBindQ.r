...
# Catchabilities
MSH.ctrl@catchabilities["MS HERAS",]        <- c(1,1,2,3,3,4,5,5,5)
MSH.ctrl@catchabilities["WoS HERAS",]       <- c(101:104,104,105:107,107)
#MSH.ctrl@catchabilities["IBTS_Q1",ac(2:9)]  <- c(202:208,208)
#MSH.ctrl@catchabilities["IBTS_Q4",ac(2:9)]  <- c(302:308,308)
MSH.ctrl@catchabilities[4:5,ac(9)]            <- 403:404
...
MSH.ctrl@cor.obs["MS HERAS",]               <- rep(1,8)
...
mean(mohns.rho(MSH.retro,ref.year=2017,span=7,type="ssb")[1:7,1])
mean(mohns.rho(MSH.retro,ref.year=2017,span=7,type="rec")[1:7,1])
mean(mohns.rho(MSH.retro,ref.year=2017,span=7,type="fbar")[1:7,1])