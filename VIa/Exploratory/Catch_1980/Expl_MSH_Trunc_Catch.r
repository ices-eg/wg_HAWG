...
### ======================================================================================================
path<-"C:/Work//HAWG/2018/wg_HAWG/VIa/Exploratory/Catch_1980/"
...
MSH.ctrl@catchabilities["IBTS_Q1",ac(2:9)]  <- c(7, rep(8,7))
MSH.ctrl@catchabilities["IBTS_Q4",ac(2:9)]  <- c(9, rep(10,7))
...
#Update stock object
MSH <- MSH + MSH.sam
save(MSH,MSH.sam,MSH.tun,MSH.ctrl,file=file.path(output.dir,"Final_6a7bcHerring.Rdata"))
load(paste(output.dir, "/Final_6a7bcHerring.Rdata", sep=""))
...
pdf(paste(output.base,"results2017_MSH_final2.pdf",sep=""))
