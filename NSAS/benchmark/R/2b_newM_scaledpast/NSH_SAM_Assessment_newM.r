...
### ======================================================================================================
output.dir          <-  file.path(".","results/2b_newM_scaledpast/")        # figures directory
...
source(file.path("R/2b_newM_scaledpast/setupAssessmentObjects_newM.r"))
source(file.path("R/2b_newM_scaledpast/setupControlObject_newM.r"))
source("D:/GIT/wg_HAWG/_Common/Stacked Area plot.r")
...
name(NSH.sam) <- "newMscaled2014"

#Update stock object
NSH       <- NSH + NSH.sam
NSH@stock <- computeStock(NSH)
name(NSH) <- "newMscaled2014"
