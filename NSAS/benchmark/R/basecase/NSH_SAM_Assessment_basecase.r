...
### ======================================================================================================
output.dir          <-  file.path(".","results/basecase/")                #figures directory
...
source(file.path("R/basecase/setupAssessmentObjects_basecase.r"))
source(file.path("R/basecase/setupControlObject_basecase.r"))
