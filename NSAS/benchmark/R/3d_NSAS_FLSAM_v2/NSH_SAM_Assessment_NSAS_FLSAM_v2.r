...
### ======================================================================================================
output.dir          <-  file.path(".","results/3d_NSAS_FLSAM_v2/")        # figures directory
...
source(file.path("R/3d_NSAS_FLSAM_v2/setupAssessmentObjects_NSAS_FLSAM_v2.r"))
source(file.path("R/3d_NSAS_FLSAM_v2/setupControlObject_NSAS_FLSAM_v2.r"))
...
name(NSH.sam) <- "NSAS_FLSAM_v2"

#Update stock object
NSH       <- NSH + NSH.sam
NSH@stock <- computeStock(NSH)
name(NSH) <- "NSAS_FLSAM_v2"
