...
### ======================================================================================================
output.dir          <-  file.path(path,"data/M_scaled_profile/")                #data directory
...
# use +0.11 as the result of the likelyhood profiling
for(idxAge in 1:length(agesM)){
  SMSher$M[SMSher$Age == agesM[idxAge]] <- SMSher$M[SMSher$Age == agesM[idxAge]]+0.11
}
...
write.csv(finalM,file=paste(output.dir,"/Smoothed_span50_M_NotExtrapolated_NSAS2016_scaled_profile.csv",sep=""))
write.csv(finalM,file=paste(input.dir,"/Smoothed_span50_M_NotExtrapolated_NSAS2016_scaled_profile.csv",sep=""))
