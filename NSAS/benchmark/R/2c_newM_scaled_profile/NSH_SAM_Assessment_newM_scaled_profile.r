...
### ======================================================================================================
output.dir          <-  file.path(".","results/2c_newM_scaled_profile/")                #figures directory
...
source(file.path("R/2c_newM_scaled_profile/setupAssessmentObjects_newM_scaled_profile.r"))
source(file.path("R/2c_newM_scaled_profile/setupControlObject_newM_scaled_profile.r"))
...
name(NSH.sam) <- "newM_scaled_profile"

#Update stock object
NSH       <- NSH + NSH.sam
NSH@stock <- computeStock(NSH)
name(NSH) <- "newM_scaled_profile"
