...
### ======================================================================================================
output.dir          <-  file.path(".","results/newFprop/")                #figures directory
...
source(file.path("R/newFprop/setupAssessmentObjects_newFprop.r"))
source(file.path("R/newFprop/setupControlObject_newFprop.r"))
