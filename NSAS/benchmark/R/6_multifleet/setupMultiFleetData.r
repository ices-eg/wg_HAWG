...
NSHmf@catch.n[,ac(1997:2016),,,"A"]   <- setMatrixPlusGroupN(caA)
NSHmf@catch.n[,ac(1997:2016),,,"B"]   <- setMatrixPlusGroupN(caB)
NSHmf@catch.n[,ac(1997:2016),,,"C"]   <- setMatrixPlusGroupN(caC)
NSHmf@catch.n[,ac(1997:2016),,,"D"]   <- setMatrixPlusGroupN(caD)
NSHmf@catch.wt[,ac(1997:2016),,,"A"]  <- setMatrixPlusGroupWt(caA,cwA)
NSHmf@catch.wt[,ac(1997:2016),,,"B"]  <- setMatrixPlusGroupWt(caB,cwB)
NSHmf@catch.wt[,ac(1997:2016),,,"C"]  <- setMatrixPlusGroupWt(caC,cwC)
NSHmf@catch.wt[,ac(1997:2016),,,"D"]  <- setMatrixPlusGroupWt(caD,cwD)
NSHmf@catch.n[,ac(1947:1996),,,-1]    <- NA
NSHmf@catch.wt[,ac(1947:1996),,,-1]   <- NA

NSH3f <- expand(NSH,area=c("A","BD","C"))
NSH3f@catch.n[,ac(1997:2016),,,"A"]   <- setMatrixPlusGroupN(caA)
NSH3f@catch.n[,ac(1997:2016),,,"BD"]   <- setMatrixPlusGroupN(caB+caD)
NSH3f@catch.n[,ac(1997:2016),,,"C"]   <- setMatrixPlusGroupN(caC)
NSH3f@catch.wt[,ac(1997:2016),,,"A"]  <- setMatrixPlusGroupWt(caA,cwA)
NSH3f@catch.wt[,ac(1997:2016),,,"BD"]  <- setMatrixPlusGroupWt(caB+caD,(cwB*caB + cwD*caD)/(caB+caD))
NSH3f@catch.wt[,ac(1997:2016),,,"C"]  <- setMatrixPlusGroupWt(caC,cwC)
NSH3f@catch.n[,ac(1947:1996),,,-1]    <- NA
NSH3f@catch.wt[,ac(1947:1996),,,-1]   <- NA

NSHsum <- NSHmf[,ac(1947:1996),,,1]
NSHres4 <- NSHmf[,ac(1997:2016)]; NSHres4@landings.n[] <- NSHres4@catch.n
NSHres3 <- NSH3f[,ac(1997:2016)]; NSHres3@landings.n[] <- NSHres3@catch.n
