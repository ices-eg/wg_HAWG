...
source(file.path("R/3b_newIBTSQ1_allAges/setupAssessmentObjects_newIBTSQ1_allAges.r"))
source(file.path("R/3b_newIBTSQ1_allAges/setupControlObject_newIBTSQ1_allAges.r"))
...
name(NSH.sam) <- "newIBTSQ1_allAges"

#Update stock object
NSH       <- NSH + NSH.sam
NSH@stock <- computeStock(NSH)
name(NSH) <- "newIBTSQ1_allAges"
