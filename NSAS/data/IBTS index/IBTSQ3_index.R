...
if(read_raw){
  ...
  ca <- getDATRAS("CA", survey = "NS-IBTS", years = yearlist:year_last, quarters = quarter)
  hl <- getDATRAS("HL", survey = "NS-IBTS", years = yearlist:year_last, quarters = quarter)
  hh <- getDATRAS("HH", survey = "NS-IBTS", years = yearlist:year_last, quarters = quarter)
  ...
  save(IBTS, file = file.path('.',"IBTSQ3",'DATRAS_IBTSQ3.RData'))
}else{
  load(file = file.path('.',"IBTSQ3",'DATRAS_IBTSQ3.RData'))
}
