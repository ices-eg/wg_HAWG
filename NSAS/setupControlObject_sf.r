...
NSH.ctrl@obs.vars["IBTS-Q3",ac(0:5)]        <- c(200,201,202,202,202,202)
NSH.ctrl@obs.vars["HERAS",ac(1:8)]          <- c(101,102,rep(102,4),rep(103,2))
...
NSH.ctrl@catchabilities["IBTS-Q3",ac(0:5)]  <- c(200:204,205)
NSH.ctrl@catchabilities["IBTS-Q1",ac(1)]    <- c(301)

#Add correlation correction for Q3 survey, not for HERAS
  idx                                       <- which(rownames(NSH.ctrl@cor.obs)=="IBTS-Q3")
NSH.ctrl@cor.obs[idx,1:5]                   <- c(rep(102,5))
