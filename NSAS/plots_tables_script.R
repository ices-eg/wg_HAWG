...
# loading
load(paste(output.dir,"/NSH_final.RData",sep=""))
...
savePlot(paste(output.dir,"/",assessment_name_singlefleet,"_4_variances.png",sep = ""),type="png")
...
savePlot(paste(output.dir,"/",assessment_name_singlefleet,"_5_CV_vs_var.png",sep = ""),type="png")
...
savePlot(paste(output.dir,"/",assessment_name_singlefleet,"_7_corr_SAM_params.png",sep = ""),type="png")
...
xyplot(age ~ year,data=dat,cex=dat$std.res,col="black",main="Residuals by year Catch",
       panel=function(...){
         lst <- list(...)
         panel.xyplot(lst$x,lst$y,pch=ifelse(lst$cex>0,1,18),col="black",cex=3*abs(lst$cex))
       })

savePlot(paste(output.dir,"/",assessment_name_singlefleet,"_8_residuals_catch.png",sep = ""),type="png")
...
savePlot(paste(output.dir,"/",assessment_name_singlefleet,"_22_residuals_IBTSQ1.png",sep = ""),type="png")

# process error in terms of N
procerr.plot(NSH+NSH.sam,weight="stock.wt",type="n",rel=T)

savePlot(paste(output.dir,"/",assessment_name_singlefleet,"_10_process_error_N.png",sep = ""),type="png")

# process error in terms of additional mortality
procerr.plot(NSH+NSH.sam,weight="stock.wt",type="mort",rel=F)

savePlot(paste(output.dir,"/",assessment_name_singlefleet,"_11_process_error_M.png",sep = ""),type="png")

# figure - times series for each age, stock
timeseries(window(NSH,1975,range(NSH)["maxyear"]),slot="stock.wt")

savePlot(paste(output.dir,"/",assessment_name_singlefleet,"_12_time_series_stock_weight.png",sep = ""),type="png")

# figure - times series for each age, catches
timeseries(window(NSH,1975,range(NSH)["maxyear"]),slot="catch.wt")

savePlot(paste(output.dir,"/",assessment_name_singlefleet,"_13_time_series_catch_weight.png",sep = ""),type="png")

# figure - times series for each age, harvest
timeseries(window(NSH,2000,range(NSH)["maxyear"]),slot="harvest")

savePlot(paste(output.dir,"/",assessment_name_singlefleet,"_14_time_series_harvest.png",sep = ""),type="png")

# figure - times series for each age, maturity
timeseries(window(NSH,1990,range(NSH)["maxyear"]),slot="mat")

savePlot(paste(output.dir,"/",assessment_name_singlefleet,"_15_time_series_mat.png",sep = ""),type="png")

# figure - times series for each age, mortality
timeseries(window(NSH,1947,range(NSH)["maxyear"]),slot="m")

savePlot(paste(output.dir,"/",assessment_name_singlefleet,"_16_time_series_M.png",sep = ""),type="png")
...
savePlot(paste(output.dir,"/",assessment_name_singlefleet,"_17_prop_acoustic_index.png",sep = ""),type="png")
...
savePlot(paste(output.dir,"/",assessment_name_singlefleet,"_TAC_catch.png",sep = ""),type="png")
...
savePlot(paste(output.dir,"/",assessment_name_singlefleet,"_19_weight_cohort.png",sep = ""),type="png")

# figure - plot of time series: IBTS0, IBTSQ1 by cohort.
overlayTimeseries(FLQuants(IBTS0=NSH.tun[["IBTS0"]]@index,IBTSQ1=NSH.tun[["IBTS-Q1"]]@index),nyrs=20,ages=0:1)

savePlot(paste(output.dir,"/",assessment_name_singlefleet,"_20_IBTSQ1_IBTS0.png",sep = ""),type="png")
...
savePlot(paste(output.dir,"/",assessment_name_singlefleet,"_21_catch_N.png",sep = ""),type="png")

# figure - residual IBTSQ3
...
#savePlot(paste(output.dir,"/",assessment_name_singlefleet,"_residuals_IBTSQ3.png",sep = ""),type="png")

# figure - residual IBTSQ1
#dat <- subset(residuals(NSH.sam),fleet=="IBTS-Q1")
...
savePlot(paste(output.dir,"/",assessment_name_singlefleet,"_18_HERAS_consistency.png",sep = ""),type="png")
...
savePlot(paste(output.dir,"/",assessment_name,"_selectivity_fleetA.png",sep = ""),type="png")
...
savePlot(paste(output.dir,"/",assessment_name,"_selectivity_fleetBD.png",sep = ""),type="png")
