...
script_name         <-  'comparison_single_multi'
...
load(file.path(".","/results/NSH_mf_final.RData"))
fit1.stck  <-NSH
fit1.flsam <-NSH3f.sam

load(file.path(".","/results/NSH_final.RData")  )
fit2.stck  <-NSH
fit2.flsam <-NSH.sam
...
st.names <- c("multi-fleet","single fleet")
...
plot(flsam)
savePlot(paste(output.dir,"/",script_name,"_stock_trajectory.png",sep = ""),type="png")
