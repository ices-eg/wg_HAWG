...
parameters <- list(
  ...
  logSdSSB=rep(-1,4),                                                           # Variances of LAI observations
...
# Estimation without correlation between random walks in Ps
...
#- Estimate states
rep<-sdreport(obj)
save(opt,rep,file="slamOutput.RData")
