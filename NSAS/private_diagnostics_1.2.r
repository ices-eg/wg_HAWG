...
#Survey MLAI
MLAI.hist   <- matrix(c(13.3,7.945,2.73,2.458,6.105,7.369,14.428,9.859,14.537,21.029,26.975,48.816,74.347,38.632,67.99,134.915,131.571,170.589,89.67,41.885,29.848,20.652,22.736,44.734,57.253,74.389,61.909,41.087,130.313,110.964,271.653,321.995,192.708,117.856,173.003),nrow=1,dimnames=list(age=c("all"),year=seq(range(NSH.tun[[1]])["minyear"],range(NSH.tun[[1]])["maxyear"],1)))
...
#Survey MIK
MIK.hist  <- matrix(c(17.1,13.1,52.1,101.1,76.7,133.9,91.8,115,181.3,177.4,270.9,168.9,71.4,25.9,69.9,200.7,190.1,101.7,127,106.5,148.1,53.1,244,137.1,214.8,161.8,54.4,47.3,61.3,83.1,37.2,27.8),nrow=1,dimnames=list(age=c(0),year=seq(1976,2007,1)))
