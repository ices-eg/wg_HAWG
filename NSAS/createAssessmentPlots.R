...
if(PDF) pdf(file.path(output.dir,paste(assessment_name_multifleet,"_1_fit_diagnostics_",sep="")))
if(PNG) png(file.path(output.dir,paste(assessment_name_multifleet,"_1_fit_diagnostics_%02d.png",sep="")),units = "px", height=800,width=672, bg = "white")
...
savePlot(paste(output.dir,"/",assessment_name_multifleet,"_7_fishing_selectivity_zoom_A.png",sep = ""),type="png")
...
savePlot(paste(output.dir,"/",assessment_name_multifleet,"_7_fishing_selectivity_zoom_BD.png",sep = ""),type="png")
...
savePlot(paste(output.dir,"/",assessment_name_multifleet,"_7_fishing_selectivity_zoom_C.png",sep = ""),type="png")

# figure - correlation matrix of model parameters
cor.plot(NSH3f.sam)

savePlot(paste(output.dir,"/",assessment_name_multifleet,"_8_corr_SAM_params.png",sep = ""),type="png")
...
savePlot(paste(output.dir,"/",assessment_name_multifleet,"_9_residuals_catch.png",sep = ""),type="png")
...
savePlot(paste(output.dir,"/",assessment_name_multifleet,"_10_residuals_IBTSQ1.png",sep = ""),type="png")
...
savePlot(paste(output.dir,"/",assessment_name_multifleet,"_11_residuals_IBTSQ3.png",sep = ""),type="png")
...
savePlot(paste(output.dir,"/",assessment_name_multifleet,"_12_residuals_HERAS.png",sep = ""),type="png")

# retro stock trajectory
plot(NSH3f.retro)

savePlot(paste(output.dir,"/",assessment_name_multifleet,"_13_retro.png",sep = ""),type="png")
...
savePlot(paste(output.dir,"/",assessment_name_multifleet,"_14_comp_single_fleet_SSB.png",sep = ""),type="png")
...
savePlot(paste(output.dir,"/",assessment_name_multifleet,"_14_comp_single_fleet_fbar.png",sep = ""),type="png")
...
savePlot(paste(output.dir,"/",assessment_name_multifleet,"_14_comp_single_fleet_rec.png",sep = ""),type="png")
