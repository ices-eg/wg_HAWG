...
t %>% 
  ...
  pander::pandoc.table(style="simple", split.tables = 200, digits=0, justify="right")
...
t %>% 
  ...
  reshape2::dcast(division ~ year, value.var="catch", sum, margins="division") %>% 
  pandoc.table(., 
             style        = "simple",
             split.tables = 200, 
...
t %>% 
  filter(year %in% 2004:2011) %>% 
  reshape2::dcast(country ~ year, value.var="catch", sum, margins="country") %>% 
  pandoc.table(., 
             style        = "simple",
             split.tables = 200, 
             split.cells  = c(rep(7,10)),
