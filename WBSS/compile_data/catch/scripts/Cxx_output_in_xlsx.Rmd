...
```{r, evel = T}
canumFS<-readRDS(paste(dataPath,"C6_her2024_canum_wbss_nsas_2018.rds", sep=""))
...
wbss all areas
```{r, evel = T}
wbss3<-readRDS(paste(dataPath,"C6_her2024_canum_wbss_nsas_2018.rds", sep=""))
wbss3$weca_kg<-wbss3$weca_g/1000
wbss3<-wbss3[,c("year","area","quarter","wr","wbss_canum_1000","weca_kg","weca_g")]

wbss4<-read.table(paste(dataPath,"canum_weca_WBSS_in_NS.csv", sep=""), sep=",", header=T)
