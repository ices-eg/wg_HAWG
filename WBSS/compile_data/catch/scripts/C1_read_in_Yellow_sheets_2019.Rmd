---
title: "C1 -  read in 'Yellow sheets' from 2018 in 2019"
...
rawDataPath <- "Q:/mynd/Assessement_discard_and_the_like/WG/HAWG/WBSS_SC/wg_HAWG/WBSS/compile_data/catch/data/2019/yellow_sheets/"
dataPath <- "Q:/mynd/Assessement_discard_and_the_like/WG/HAWG/WBSS_SC/wg_HAWG/WBSS/compile_data/catch/data/2019/results/"
...
gerFile <- "2_2019 DC HAWG her.27.2024 DE AC4_small revision_v2.xls"
...
finFile <- "DC_Annex 7.1.3. HAWG Template_her_2024_FIN_2018.xls"
```
...
finC <-
  read_in_catch(paste(rawDataPath, finFile, sep = ""),
                sheets = c(3),
                noAreas = 29)
...
```{r, include=F}
canum <- rbind(dnk, ger, pol, swe, nor, fro, fin)
...
```{r, include=F}
samp <- rbind(dnkS, gerS, polS, sweS, norS, froS, finS)
...
```{r, include=F}
catch <- rbind(dnkC, polC, gerC, sweC, norC, froC, finC)
