...
split<-read.table(paste(dataPath,"input_C_split_proportions_3a_2017.csv", sep=""), sep=",", header=T)
str(split)
...
```{r}
canum<-readRDS(paste(dataPath, "C5_her2024_canum_with_imputations_2017.rds", sep=""))
...
```{r}
#WBSS and NSAS
write.table(splitted, paste(dataPath,"C6_her2024_canum_wbss_nsas_2017.csv", sep=""), sep=",", row.names=F)
saveRDS(splitted, paste(dataPath,"C6_her2024_canum_wbss_nsas_2017.rds", sep=""))
```
