...
```{r}
filled<-read.table(paste(dataPath, "C4_her2024_missing_bio_", year, "_filled.csv", sep=""), sep=",", header=T)
...
canum<-readRDS(paste(dataPath,"C1_her2024_canum_without_imputations_", year, ".rds", sep=""))
names(canum)
...
saveRDS(final, paste(dataPath, "C5_her2024_canum_with_imputations_", year, ".rds", sep=""))
write.table(final, paste(dataPath, "C5_her2024_canum_with_imputations_", year, ".csv", sep=""), sep=",", row.names=F)
