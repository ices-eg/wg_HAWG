 ...
 model_data(argc,argv) , function_minimizer(sz)
{
 ...
 if(corFlag==0){cor_phase=-1;}
  rho.allocate(-0.99,0.99,cor_phase,"rho");
  logScale.allocate(1,noScaledPar,"logScale");
  logScaleSSB.allocate(ssbPhase,"logScaleSSB");
  logPowSSB.allocate(ssbPowPhase,"logPowSSB");
  logSdSSB.allocate(ssbPhase,"logSdSSB");
  ...
  ssb.allocate(1,noYears,"ssb");
  logssb.allocate(1,noYears,"logssb");
  logCatch.allocate(minYearResFleet,maxYearResFleet,"logCatch");
  fbar.allocate(1,noYears,"fbar");
  logfbar.allocate(1,noYears,"logfbar");
  tsb.allocate(1,noYears,"tsb");
  logtsb.allocate(1,noYears,"logtsb");
