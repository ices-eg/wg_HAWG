...
#path<-"H:/ICES/MeetingArchives/HAWG/2016/Forecast/2016"
#path<-"L:/PERSONAL/Afra/ASAP/2017 HAWG Final/stf_HAWG_FINAL_2017"
path<-"C:/Users/momalley/Desktop/HAWG 2017/2017 HAWG FINAL/stf_HAWG_FINAL_2017"
...
#AdY.catch <- 15442 #2016 TAC
AdY.catch<-14467 #2017 TAC
...
options.l <- list(#Zero catch
  ...
  "Fbar(2018) = 0.17"=
    fwdControl(data.frame(year=c(ImY,AdY,CtY),
                          quantity=c("catch","f","f"),
                          rel=c(NA,NA,AdY),
                          val=c(ImY.catch,0.17,NA))),
  "Fbar(2018) = 0.14"=
    fwdControl(data.frame(year=c(ImY,AdY,CtY),
                          quantity=c("catch","f","f"),
                          rel=c(NA,NA,AdY),
                          val=c(ImY.catch,0.14,NA))),
  "Fbar(2018) = 0.6"=
    fwdControl(data.frame(year=c(ImY,AdY,CtY),
                          quantity=c("catch","f","f"),
                          rel=c(NA,NA,AdY),
                          val=c(ImY.catch,0.6,NA))),
  "Fbar(2018) = 1.5"=
    fwdControl(data.frame(year=c(ImY,AdY,CtY),
                          quantity=c("catch","f","f"),
                          rel=c(NA,NA,AdY),
                          val=c(ImY.catch,1.5,NA))),
  "Fbar(2018) = 1.4"=
    fwdControl(data.frame(year=c(ImY,AdY,CtY),
                          quantity=c("catch","f","f"),
                          rel=c(NA,NA,AdY),
                          val=c(ImY.catch,1.4,NA)))
) #End options list
