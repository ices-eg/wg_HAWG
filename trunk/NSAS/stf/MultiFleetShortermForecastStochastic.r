...
write(stf.out.file,file=paste("./","stfstochastic.out",sep="."))

#- Write the stf.table to file
write.table(stf.table[,,2],file=paste("stf.table","stochastic"),append=F,col.names=T,row.names=T)
...
save.image(file="ShortTermForecast Workspace Stochastic.RData")
