...
path <- "D:/Repository/HAWG/HAWGrepository/NSAS/samIHLS/"
...
source(file.path("R","setupAssessmentObjects_LAI.r"))
source(file.path("R","setupControlObject_LAI.r"))
...
### ============================================================================
  ...
  #Perform assessment
  NSH.sam <- FLSAM(NSH,NSH.tun,NSH.ctrl,run.dir=file.path(path,"runDir"))
...
png(file.path(output.dir,"figures - %02d.png"),units = "px", height=800,width=672, bg = "white")
  ...
  points(y=0.26,x=1.902874,col="red",pch=19)
  text(y=0.26,x=1.902874,pos=3,cex=0.7,col="red",labels=ac(2014))
